  ...
  return (
    <div className="footer-container">
      <div className="footer-unit">
        ...
        <p>
          "Explore the perfect wheels for your journey. carRental offers a wide
          selection of vehicles for all your driving needs."
        </p>
        <div className="phone">
      ...
      <div className="footer-unit">
        ...
        <p className="footer-text">Subscribe to get the latest new & updates</p>
        <input type="text" className="footer-sub" placeholder="Enter Your Email" />
